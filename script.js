...
// Quando la finestra è completamente caricata
window.addEventListener('load', () => {
  // Tempo di visualizzazione del loader in millisecondi (3000ms = 3 secondi)
  ...
  // Mostra il loader per un tempo determinato
  setTimeout(() => {
      // Fade-out del loader (dissolvenza)
      loader.style.opacity = '0'; 

      // Dopo che il loader è sparito (500ms per dissolversi)
      setTimeout(() => {
          loader.style.display = 'none'; // Nascondi il loader
          content.classList.add('active'); // Mostra il contenuto
      }, 500); // Tempo di dissolvenza
  }, loaderDuration); // Dopo 3 secondi
});
